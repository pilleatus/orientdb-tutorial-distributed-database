...
exec "$JAVA" $JAVA_OPTS $MAXHEAP $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $MAXDISKCACHE -Djava.util.logging.config.file="$LOG_FILE" -Ddistributed.backupDirectory="/orientdb/backup" -Dorientdb.config.file="$CONFIG_FILE" -Dorientdb.www.path="$WWW_PATH" -Dorientdb.build.number="2.1.x@r877c28613f3b79e91ee40f58e551f3b82d814bcf; 2016-02-04 17:14:18+0000" -cp "$ORIENTDB_HOME/lib/orientdb-server-2.1.10.jar:$ORIENTDB_HOME/lib/*" $* com.orientechnologies.orient.server.OServerMain
